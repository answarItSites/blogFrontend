  ...
  return (
    <>
      ...
      <nav className="bg-black border-b border-gray-700 fixed top-0 left-0 right-0 z-50">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute left-0 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-500 sm:block">
                    <div className="bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                      ...
                      <a href="/diets" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 border-b border-gray-200">
                        Diets
                      </a>
                      <a href="/meal-kits" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 border-b border-gray-200">
                        Meal Kits
                      </a>
                      <a href="/prepared-meals" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 border-b border-gray-200">
                        Prepared Meals
                      </a>
                      <a href="/comparisons" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 border-b border-gray-200">
                        Comparisons
                      </a>
                      <a href="/grocery-delivery" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100">
                        Grocery Delivery
                      </a>
                    </div>
                  </div>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute right-0 w-48 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-500">
                    <div className="bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                      ...
                      <a href="/super-admin" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 text-center border-b border-gray-200">
                        Super Admin
                      </a>
                      <a href="/sub-admin" className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 text-center">
                        Sub Admin
                      </a>
                    </div>
                  </div>
        ...
        {/* Mobile Menu */}
        <div className={`sm:hidden ${isOpen ? 'block' : 'hidden'} bg-black`} id="mobile-menu">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <div className="border-t border-gray-700 mt-2 pt-2">
              ...
              >
                <span>Meal Kits</span>
                <svg
                  className={`h-4 w-4 transition-transform ${isMealKitsOpen ? 'rotate-180' : ''}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <div className="border-t border-gray-700 mt-2 pt-2">
              ...
              <div className={`${isLoginOpen ? 'block' : 'hidden'} pl-4 py-2 space-y-0 bg-gray-900`}>
                <a href="/admin" className="block px-3 py-2 text-gray-300 hover:text-[#38bdf8] text-base font-medium border-b border-gray-700" onClick={handleMenuItemClick}>
                  Admin
                </a>
                <a href="/super-admin" className="block px-3 py-2 text-gray-300 hover:text-[#38bdf8] text-base font-medium border-b border-gray-700" onClick={handleMenuItemClick}>
                  Super Admin
                </a>
                <a href="/sub-admin" className="block px-3 py-2 text-gray-300 hover:text-[#38bdf8] text-base font-medium" onClick={handleMenuItemClick}>
                  Sub Admin
                </a>
              </div>
            </div>
